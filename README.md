...
## foxglove_msgs (melodic) - 2.1.1-1

The packages in the `foxglove_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release foxglove_msgs --ros-distro melodic` on `Tue, 29 Nov 2022 17:29:03 -0000`
...
## foxglove_msgs (noetic) - 2.1.0-1

The packages in the `foxglove_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release foxglove_msgs --ros-distro noetic` on `Fri, 18 Nov 2022 18:56:35 -0000`
...
## foxglove_msgs (melodic) - 2.1.0-2

The packages in the `foxglove_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release foxglove_msgs --ros-distro melodic` on `Fri, 18 Nov 2022 18:54:06 -0000`
...
## foxglove_msgs (melodic) - 2.1.0-1

The packages in the `foxglove_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release foxglove_msgs --ros-distro melodic` on `Fri, 18 Nov 2022 18:47:50 -0000`
...
## foxglove_msgs (noetic) - 2.0.0-1

The packages in the `foxglove_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release foxglove_msgs --ros-distro noetic` on `Fri, 15 Jul 2022 19:13:28 -0000`
...
## foxglove_msgs (melodic) - 2.0.0-1

The packages in the `foxglove_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release foxglove_msgs --ros-distro melodic` on `Fri, 15 Jul 2022 19:06:44 -0000`
